...
class LSTMUnitLayer : public Layer<Dtype> {
 ...
 protected:
  ...
  int hidden_dim_;
  Blob<Dtype> net_inputs_map_;
  Blob<Dtype> cell_states_map_;
  Blob<Dtype> forget_gates_map_;
  Blob<Dtype> input_gates_map_;
  Blob<Dtype> output_gates_map_;
  Blob<Dtype> cell_outputs_diff_;
  Blob<Dtype> cell_states_diff_;
